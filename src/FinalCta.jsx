...
const FinalCta = () => {
  return (
    <section style={{
      ...
      <Asterisk size={500} color="black" style={{
        position: 'absolute', top: '-150px', left: '-150px',
        opacity: 0.06, animation: 'spin-slow 60s linear infinite'
      }} />
      <Asterisk size={400} color="black" style={{
        position: 'absolute', bottom: '-150px', right: '-100px',
        opacity: 0.08, animation: 'spin-rev 45s linear infinite'
      }} />

      <div className="container" style={{ position: 'relative', textAlign: 'center' }}>
        <div className="reveal" style={{ display: 'inline-block', marginBottom: '32px' }}>
          <img src="assets/ativo-7-fundo-laranja.png" alt=""
          style={{ width: '180px', animation: 'float-y 4s ease-in-out infinite' }} />
        ...
        <p className="reveal" style={{
          ...
          maxWidth: '720px', margin: '0 auto 16px'
        }}>
        ...
        <div className="reveal" style={{
          ...
          flexWrap: 'wrap', marginTop: '24px', marginBottom: '40px',
          fontFamily: "'Bricolage Grotesque', sans-serif",
          ...
          <span style={{ display: 'inline-flex', alignItems: 'center', gap: '8px' }}>
            <Asterisk size={14} color="black" /> Menos bagunça.
          </span>
          <span style={{ display: 'inline-flex', alignItems: 'center', gap: '8px' }}>
            <Asterisk size={14} color="black" /> Mais praticidade.
          </span>
          <span style={{ display: 'inline-flex', alignItems: 'center', gap: '8px' }}>
            <Asterisk size={14} color="black" /> Mais profissional.
          </span>
        </div>
      ...
      marginBottom: '48px'
        ...
        <div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '16px', marginBottom: '20px' }}>
            ...
            }}>Estúdio de design e presença digital</div>
            </div>
          </div>
          <p style={{
          fontFamily: "'DM Sans', sans-serif", fontSize: '15px',
          color: 'rgba(242,238,229,0.6)', lineHeight: 1.6,
          maxWidth: '420px'
        }}>
        ...
        onMouseLeave={(e) => e.currentTarget.style.color = 'rgba(242,238,229,0.7)'}>
          {l}</a>
        )}
        </div>
        ...
        <div>
          ...
          display: 'block',
          fontFamily: "'DM Sans', sans-serif", fontSize: '14px',
          color: 'rgba(242,238,229,0.7)', padding: '6px 0'
        }}>WhatsApp</a>
          <a href="#" style={{
          display: 'block',
          fontFamily: "'DM Sans', sans-serif", fontSize: '14px',
