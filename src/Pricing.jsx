...
const PLANS = [
  {
    id: 'essencial',
    name: 'Essencial',
    target: 'Para profissional solo ou negócio pequeno',
    price: '187',
    cents: '00',
    full: '1.868',
    ...
    features: [
      ...
      'Fotos da empresa ou do profissional',
      'Integração com Google Agenda',
      'Confirmação automática por WhatsApp',
      'Aviso interno de novo agendamento',
      'Lembrete automático no dia',
      'Link para bio, site ou WhatsApp',
      'Manutenção técnica do sistema',
    ],
  },
  {
    id: 'equipe',
    name: 'Equipe',
    target: 'Para negócios com até 5 profissionais',
    price: '250',
    cents: '00',
    full: '2.497',
    cta: 'Quero o Equipe',
    ...
    features: [
      ...
      'Até 40 serviços cadastrados',
      'Escolha de profissional no agendamento',
      'Categorias de serviços',
      'Layout personalizado',
      'Fotos da equipe',
      'Integração com Google Agenda',
      'Confirmação + lembrete WhatsApp',
      'Aviso interno de novo agendamento',
      'Manutenção técnica do sistema',
    ],
  },
  {
    id: 'completo',
    name: 'Completo',
    target: 'Para negócios que querem pagamento no agendamento',
    price: '350',
    cents: '00',
    full: '3.497',
    ...
    features: [
      ...
      'Integração do pagamento ao processo',
      'Confirmação após o pagamento',
      'Organização dos serviços com valor',
      'Experiência mais completa para o cliente',
      'Suporte técnico da estrutura com pagamento',
    ],
  },
];
    ...
    <section id="planos" style={{
      ...
      <div className="container" style={{ position: 'relative' }}>
        ...
        <div style={{
          ...
          {PLANS.map((p, i) => <PlanCard key={p.id} plan={p} delay={i * 100} />)}
        </div>
        ...
        <div className="reveal" style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
            ...
            <div>
              ...
              }}>Mais profissionais, serviços, unidades ou números internos — adicione na hora de fechar o pedido.</div>
            </div>
          </div>
  ...
  return (
    <div
      ...
      style={{
        ...
        transform: hover ? 'translate(-4px, -4px)' : (featured ? 'translateY(-12px)' : 'none'),
    ...
    >
      ...
      <div style={{
        ...
        color: featured ? 'rgba(242,238,229,0.6)' : 'rgba(0,0,0,0.55)',
        marginBottom: '24px',
        minHeight: '36px',
      }}>{plan.target}</div>
      ...
      <div style={{
        ...
        color: featured ? 'var(--offwhite)' : 'var(--offwhite)',
        borderRadius: '16px',
        padding: '20px',
        marginBottom: '24px',
      }}>
        <div style={{
          ...
          color: featured ? 'var(--orange)' : 'var(--orange)',
        ...
        <div style={{
          fontFamily: "'DM Sans', sans-serif", fontSize: '13px',
          color: featured ? 'rgba(242,238,229,0.7)' : 'rgba(242,238,229,0.7)',
          marginTop: '8px',
        }}>
      ...
      <ul style={{
        ...
        {plan.features.map((f, i) => (
          <li key={i} style={{
            ...
            color: featured ? 'rgba(242,238,229,0.85)' : 'rgba(0,0,0,0.8)',
          }}>
            <span style={{
      ...
      <Btn variant={featured ? 'primary' : 'dark'} size="md" style={{ width: '100%', justifyContent: 'center' }}>
        {plan.cta}
      </Btn>
      ...
      <div style={{
        marginTop: '20px',
        paddingTop: '16px',
        borderTop: '1px dashed ' + (featured ? 'rgba(242,238,229,0.18)' : 'rgba(0,0,0,0.18)'),
        fontFamily: "'DM Sans', sans-serif",
        fontSize: '12px',
        color: featured ? 'rgba(242,238,229,0.6)' : 'rgba(0,0,0,0.55)',
      }}>
        <strong style={{ display: 'block', marginBottom: '2px', color: featured ? 'var(--offwhite)' : '#000' }}>
          Renovação após o 1º ano
        </strong>
