      ...
      <div className="container" style={{
        ...
        <div>
          ...
          <div style={{ display: 'flex', gap: '16px', alignItems: 'center', flexWrap: 'wrap', marginBottom: '48px' }}>
            <Btn variant="primary" size="lg" onClick={() => document.getElementById('planos')?.scrollIntoView({ behavior: 'smooth' })}>
              Quero minha agenda
            </Btn>
            <Btn variant="outline" size="lg" onClick={() => document.getElementById('demo')?.scrollIntoView({ behavior: 'smooth' })}>
              Ver demonstração
            </Btn>
          </div>

          {/* Stat row */}
          <div style={{ display: 'flex', gap: '40px', flexWrap: 'wrap', width: "607.08px" }}>
            {[
